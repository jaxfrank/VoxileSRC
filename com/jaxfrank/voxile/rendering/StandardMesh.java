...
//TODO: Rework to allow for custom Vertices
// Enable and disable each attribute
public class StandardMesh {
	private int vbo;
	private int ibo;
	private int size;

	protected StandardMesh() {
		
	}
	
	public StandardMesh(String fileName) {
		initMeshData();
		loadMesh(fileName);
	}

	public StandardMesh(ArrayList<Vertex> vertices, ArrayList<Integer> indices) {
		this(vertices, indices, false);
	}

	public StandardMesh(ArrayList<Vertex> vertices, ArrayList<Integer> indices, boolean calcNormals) {
		initMeshData();
		...
		addVertices(verts, indexes, calcNormals);
	}
	
	public StandardMesh(Vertex[] vertices, int[] indices) {
		this(vertices, indices, false);
	}

	public StandardMesh(Vertex[] vertices, int[] indices, boolean calcNormals) {
		initMeshData();
	...
	private StandardMesh loadMesh(String fileName) {
